...
const (
	...
	// Minimum number of occurrences for a topic to be considered trending
	minTrendingCount = 2
...
// Only topics mentioned at least minTrendingCount times are included.
